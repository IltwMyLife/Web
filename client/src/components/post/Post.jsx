			...
			<div className='post__wrapper'>
				<div className='post__top'>
					<div className='post__top-left'>
						<Link to={`/profile/${user.username}`}>
							<img className='post__profile-img' src={user.profilePicture ? PF + 'person/' + user.profilePicture :  PF + 'person/noAvatar.png'} alt='' />
						</Link>
				...
				<div className='post__bottom'>
					...
					<div className='post__bottom-right'>
						<span className="post__comment-text">{post.comment} комментариев</span>
					</div>
				</div>
			</div>
		</div>
